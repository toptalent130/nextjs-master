...
import VideoCapture from '../common/VideoCapture';
...
class Examination extends Component {
  ...
  handleChange = (e) => {
    this.setState({
      examanswer:{...this.state.examanswer,[e.target.name]: e.target.value},
    });
  ...
  render() {
    ...
    const {examination} = this.props.problems;
      ...
      <div className="question mb-5">
          <div className="row">
            <div className="col-md-8 m-auto">
              <h1 className="display-4">Examination </h1> 
...
export default connect(mapStateToProps, { getExamination, saveExamination })(withRouter(Examination));
