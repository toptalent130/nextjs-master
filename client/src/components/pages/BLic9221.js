...
class BLic9221 extends Component {
	...
	render() {
		...
		return (
				<form onSubmit={this.onSubmit} className="main-page bubble-element Page" style={{width: "794px", height: "54015px", minHeight: "100%", marginRight: "auto", marginLeft: "auto", position: "relative", top: "0px", overflow: "hidden", background: "none rgb(153, 153, 153)", boxSizing: "border-box"}}>
					...
					<div className="bubble-r-line" id="prereview" style={{marginTop: "17px", height: "1123px"}}>
						<div className="bubble-r-box" style={{height: "1123px", left: "0px", width: "794px"}}>
							...
							<div className="bubble-element Group" style={{width: "794px", left: "0px", position: "absolute", boxSizing: "border-box", height: "1123px", top: "0px", backgroundColor: "rgba(255, 255, 255, 0)", backgroundRepeat: "no-repeat", backgroundPosition: "center center", backgroundSize: "cover", borderRadius: "0px", backgroundImage: "url('https://d1muf25xaso8hp.cloudfront.net/https%3A%2F%2Fs3.amazonaws.com%2Fappforest_uf%2Ff1609943500659x899027800865421000%2F5A%2520_%25205B%2520New%2520Genius%2520Kids%2520Parent%2520Handbook%25202020-2021-21.jpg?w=1024&amp;h=&amp;auto=compress&amp;dpr=1&amp;fit=max')"}}>
								...
								<div className="bubble-r-line" style={{marginTop: "532px", height: "25px"}}>
									...
									<div className="bubble-r-box" style={{height: "24px", left: "262px", width: "175px"}}>
										<input type="text" name="text3" value={this.state.data.text3||''} onChange={this.onChange}  className="bubble-element Input" placeholder="REQUIRED" maxLength=""  tabIndex="3" style={{position: "absolute", boxSizing: "border-box", height: "24px", width: "175px", left: "0px", top: "0px", border: "1px solid rgba(171, 171, 171, 0.41)", backgroundColor: "rgb(252, 252, 252)", borderRadius: "5px", fontFamily: "Barlow", fontSize: "16px", fontWeight: "500", color: "rgb(107, 107, 107)", padding: "0px 10px"}}/>
									</div>
								...
								<div className="bubble-r-line" style={{marginTop: "17px", height: "24px"}}>
									...
									<div className="bubble-r-box" style={{height: "24px", left: "262px", width: "175px"}}>
										<input type="text" name="text6" value={this.state.data.text6||''} onChange={this.onChange}  className="bubble-element Input" placeholder="REQUIRED" maxLength="" tabIndex="6" style={{position: "absolute", boxSizing: "border-box", height: "24px", width: "175px", left: "0px", top: "0px", border: "1px solid rgba(171, 171, 171, 0.41)", backgroundColor: "rgb(252, 252, 252)", borderRadius: "5px", fontFamily: "Barlow", fontSize: "16px", fontWeight: "500", color: "rgb(107, 107, 107)", padding: "0px 10px"}}/>
									</div>
								...
								<div className="bubble-r-line" style={{marginTop: "47px", height: "24px"}}>
									...
									<div className="bubble-r-box" style={{height: "24px", left: "264px", width: "175px"}}>
										<input type="text" name="text9" value={this.state.data.text9||''} onChange={this.onChange}  className="bubble-element Input" placeholder="REQUIRED" maxLength="" tabIndex="9" style={{position: "absolute", boxSizing: "border-box", height: "24px", width: "175px", left: "0px", top: "0px", border: "1px solid rgba(171, 171, 171, 0.41)", backgroundColor: "rgb(252, 252, 252)", borderRadius: "5px", fontFamily: "Barlow", fontSize: "16px", fontWeight: "500", color: "rgb(107, 107, 107)", padding: "0px 10px"}}/>
									</div>
									<div className="bubble-r-box" style={{height: "24px", left: "476px", width: "192px"}}>
										<input type="text" name="text10" value={this.state.data.text10||today} onChange={this.onChange}  className="bubble-element Input" placeholder="REQUIRED" maxLength="" tabIndex="10" style={{position: "absolute", boxSizing: "border-box", height: "24px", width: "192px", left: "0px", top: "0px", border: "1px solid rgba(171, 171, 171, 0.41)", backgroundColor: "rgb(252, 252, 252)", borderRadius: "5px", fontFamily: "Barlow", fontSize: "16px", fontWeight: "500", color: "rgb(107, 107, 107)", padding: "0px 10px"}}/>
									</div>
								</div>
							</div>
						</div>
